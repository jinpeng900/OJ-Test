...
public:
    ...
    static std::string resultToString(JudgeResult r)
    {
        switch (r)
        {
        case JudgeResult::ACCEPTED:              return "AC";
        case JudgeResult::WRONG_ANSWER:          return "WA";
        case JudgeResult::TIME_LIMIT_EXCEEDED:   return "TLE";
        case JudgeResult::MEMORY_LIMIT_EXCEEDED: return "MLE";
        case JudgeResult::RUNTIME_ERROR:         return "RE";
        case JudgeResult::COMPILE_ERROR:         return "CE";
        case JudgeResult::SYSTEM_ERROR:          return "SE";
